...
vim.keymap.set('n', '<F5>', '<cmd>lua require("dap").toggle_breakpoint()<cr>', opts)
vim.keymap.set('n', '<F6>', '<cmd>lua require("dap").continue()<cr>', opts)
vim.keymap.set('n', '<F7>', '<cmd>lua require("dap").terminate()<cr>', opts)
...
-- vim.keymap.set('n', '<F6>', '<cmd>lua require("dap").eval()()<cr>', opts)
