...
vim.api.nvim_set_keymap('n', '<F4>', '<cmd>lua StartGdbSession()<cr>', opts)
vim.api.nvim_set_keymap('n', '<F5>', '<cmd>GdbBreakpointToggle<cr>', opts)
vim.api.nvim_set_keymap('n', '<F6>', '<cmd>GdbNext<cr>', opts)
vim.api.nvim_set_keymap('n', '<F7>', '<cmd>GdbContinue<cr>', opts)
vim.api.nvim_set_keymap('n', '<F8>', '<cmd>GdbDebugStop<cr>', opts)
vim.api.nvim_set_keymap('n', '<F9>', '<cmd>lua CreateWatch()<cr>', opts)
