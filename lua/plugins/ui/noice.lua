...
require("noice").setup({
    ...
    cmdline = {
        ...
        format = {
            ...
            cmdline = { pattern = "^:", icon = icons.flash .. " ", lang = "vim" },
            search_down = { kind = "search", pattern = "^/", icon = icons.search .. " ", lang = "regex" },
            search_up = { kind = "search", pattern = "^%?", icon = icons.search .. " ", lang = "regex" },
            filter = { pattern = "^:%s*!", icon = icons.hack .. " ", lang = "bash" },
            lua = { pattern = "^:%s*lua%s+", icon = icons.file_types.lua .. " ", lang = "lua" },
            help = { pattern = "^:%s*he?l?p?%s+", icon = icons.bulb .. " " },
            input = {}, -- Used by input()
            -- lua = false, -- to disable a format, set to `false`
        },
    },
    messages = { -- show at bottom
    ...
    lsp = {
        progress = { -- using lua line lsp progress
            enabled = false,
        ...
        message = {
            ...
            enabled = true, -- neovide need this set true
            view = "notify",
            opts = {},
        },
